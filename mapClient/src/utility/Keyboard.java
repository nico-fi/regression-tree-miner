...
public class Keyboard {
	...
	/**
	 * Flag indicating whether input errors are to be printed to standard output.
	 */
	 ...
	 * output.
	 * 
	 * @param flag Boolean indicating whether input errors are to be printed to
	 *             standard output.
	 */
	 ...
	 * 
	 * @param skip Boolean indicating whether subsequent lines are used.
	 * @return Next input token.
	 */
	 ...
	 * 
	 * @return Boolean indicating whether there are no more tokens to read on the
	 *         current input line.
	 */
	 ...
	 * 
	 * @return Word read from standard input.
	 */
